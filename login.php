<?php
	...
	if(isset($_SESSION['id'])){
		header('location:indexBuyer.php');
	}
?>
...
<div class="container">
	<div id="login_form" class="well">
		...
		<div style="height: 10px;"></div>
		<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-log-in"></span> Login</button> No account? <a href="http://localhost/ECommerce/Register/signup.php"> Sign up</a>
		</form>
